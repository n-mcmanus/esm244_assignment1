...
lakes_fig <- ggplot(data = ramu_counts_lake, 
  ...
  geom_text(aes(label = count), nudge_y = 70, size = 2.5) +
  # set theme
  theme_bw() +
  theme(
    # customize axis labels
...
```
<br>
**Figure 1.** The number of *R. muscosa* observations between 1995-2002 in the southern Sierra Nevadas. Figure 1A (left) displays counts by year and life stage. No observations for *R. muscosa* were recorded for the years 1998-1999. Figure 1B (right) displays the five lakes with the greatest number of combined adult and sub-adult *R. muscosa* observations across all years.
